	        		...
	        		<div className="w3-container">
	        			<div className="w3-row">
	        				...
	        				<p className="w3-row w3-center" style={{fontSize: "24px"}}>SIGN-UP PAGE</p>
	        					<form>
	        					<button className="w3-button w3-blue">FACEBOOK</button>
	        					<button className="w3-button w3-red">GooGle</button>
	        						...
	        						<div className="w3-panel w3-green">Registered Successfully</div>:
	        						null
	        						}
	        					</form>
	        				</div>
